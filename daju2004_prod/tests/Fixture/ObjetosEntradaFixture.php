...
class ObjetosEntradaFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_objetos_has_objetos_objetos2_idx' => ['type' => 'index', 'columns' => ['objeto_id'], 'length' => []],
        ...
        '_constraints' => [
            ...
            'fk_objetos_has_objetos_objetos2' => ['type' => 'foreign', 'columns' => ['objeto_id'], 'references' => ['objetos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
