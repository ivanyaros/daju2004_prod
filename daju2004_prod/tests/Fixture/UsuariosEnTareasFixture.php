...
/**
 * UsuariosEnTareasFixture
 *
 */
class UsuariosEnTareasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'fk_usuarios_en_tareas_tareas1_idx' => ['type' => 'index', 'columns' => ['tarea_id'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'fk_usuarios_en_tareas_tareas1' => ['type' => 'foreign', 'columns' => ['tarea_id'], 'references' => ['tareas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
