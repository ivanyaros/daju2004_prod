...
class ObjetosMaterialesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_objetos_materiales_objetos1_idx' => ['type' => 'index', 'columns' => ['objeto_id'], 'length' => []],
            'fk_objetos_materiales_materiales1_idx' => ['type' => 'index', 'columns' => ['materiale_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_objetos_materiales_objetos1' => ['type' => 'foreign', 'columns' => ['objeto_id'], 'references' => ['objetos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_objetos_materiales_materiales1' => ['type' => 'foreign', 'columns' => ['materiale_id'], 'references' => ['materiales', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
