...
class MaterialesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'entradas_materiale_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'bobina_lote' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'fk_materiales_entradas_material1_idx' => ['type' => 'index', 'columns' => ['entradas_materiale_id'], 'length' => []],
        ...
        '_constraints' => [
            ...
            'fk_materiales_entradas_material1' => ['type' => 'foreign', 'columns' => ['entradas_materiale_id'], 'references' => ['entradas_de_materiales', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
    ...
    public $records = [
        [
            'id' => 1,
            'material_id' => 1,
            'fecha_entega' => '2017-05-26 08:01:24',
            'localizacione_id' => 1,
            'entradas_materiale_id' => 1,
            'bobina_lote' => 1,
            'bobinas' => 1,
            'bobinas_actual' => 1,
