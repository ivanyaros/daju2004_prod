...
class MaterialesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_materiales_entradas_material1' => ['type' => 'foreign', 'columns' => ['entradas_material_id'], 'references' => ['entradas_de_materiales', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
    ...
    public $records = [
        [
            'id' => 1,
            'material_id' => 1,
            'fecha_entega' => '2017-05-25 10:23:05',
            'localizacione_id' => 1,
