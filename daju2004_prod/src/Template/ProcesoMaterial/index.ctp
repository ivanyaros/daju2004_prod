    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $procesoMaterial->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $procesoMaterial->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $procesoMaterial->id], ['confirm' => __('Are you sure you want to delete # {0}?', $procesoMaterial->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
