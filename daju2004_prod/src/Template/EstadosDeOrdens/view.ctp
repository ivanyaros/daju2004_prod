...
<div style="display:none" id="maquinasUsadas" class="related w3-container w3-theme-d3 w3-border">
    <h4><?= __('Related Maquinas Usadas') ?>
        <button onClick="location.href='/maquinas-usadas/add/<?= $estadosDeOrden->id ?>/estados_de_orden_id'" class="w3-button w3-xlarge w3-circle w3-black">+</button>
    </h4>
...
<div style="display:none" id="usuariosEnEstadosOrden" class="related w3-container w3-theme-d3 w3-border">
    <h4><?= __('Related Usuarios En Estados Orden') ?>
        <button onClick="location.href='/usuarios-en-estados-orden/add/<?= $estadosDeOrden->id ?>/estados_de_orden_id'" class="w3-button w3-xlarge w3-circle w3-black">+</button>
    </h4>
...
<div style="display:none" id="utensiliosUsados" class="related w3-container w3-theme-d3 w3-border">
    <h4><?= __('Related Utensilios Usados') ?>
        <button onClick="location.href='/utensilios-usados/add/<?= $estadosDeOrden->id ?>/estados_de_orden_id'" class="w3-button w3-xlarge w3-circle w3-black">+</button>
    </h4>
