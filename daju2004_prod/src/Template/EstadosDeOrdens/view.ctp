...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Estados De Orden'), ['action' => 'edit', $estadosDeOrden->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Estados De Orden'), ['action' => 'delete', $estadosDeOrden->id], ['confirm' => __('Are you sure you want to delete # {0}?', $estadosDeOrden->id)]) ?> </li>
