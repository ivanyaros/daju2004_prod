    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $pedidosEmpresasProducto->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $pedidosEmpresasProducto->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $pedidosEmpresasProducto->id], ['confirm' => __('Are you sure you want to delete # {0}?', $pedidosEmpresasProducto->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
