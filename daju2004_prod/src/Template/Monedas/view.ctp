...
<div class="monedas view large-9 medium-8 columns content">
    ...
    <div class="related">
        <h4><?= __('Related Material') ?>
        	<li><?= $this->Html->link(__('New Material'), ['controller' => 'Material', 'action' => 'add',$moneda->id]) ?> </li>
        </h4>
    ...
    <div class="related">
        <h4><?= __('Related Proceso') ?>
        	<li><?= $this->Html->link(__('New Proceso'), ['controller' => 'Proceso', 'action' => 'add',$moneda->id]) ?> </li>
        </h4>
    ...
    <div class="related">
        <h4><?= __('Related Producto') ?>
        	<li><?= $this->Html->link(__('New Producto'), ['controller' => 'Producto', 'action' => 'add',$moneda->id]) ?> </li>
        </h4>
