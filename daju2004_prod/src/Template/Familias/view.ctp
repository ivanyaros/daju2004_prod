...
<div style="display:none" id="material" class="related w3-container w3-theme-d3 w3-border">
    <h4><?= __('Related Material') ?>
        <button onClick="location.href='/material/add/<?= $familia->id ?>/familia_id'" class="w3-button w3-xlarge w3-circle w3-black">+</button>
    </h4>
	...
	<div class="w3-responsive">
		<table class=" w3-table w3-border w3-bordered w3-hoverable w3-theme-d4">
        	<thead class="w3-border w3-black">  
                ...
                <th scope="col"><?= $this->Paginator->sort('moneda_id','moneda_id', ['model'=>'Material']) ?></th>
...
<div style="display:none" id="proceso" class="related w3-container w3-theme-d3 w3-border">
    <h4><?= __('Related Proceso') ?>
        <button onClick="location.href='/proceso/add/<?= $familia->id ?>/familia_id'" class="w3-button w3-xlarge w3-circle w3-black">+</button>
    </h4>
...
<div style="display:none" id="producto" class="related w3-container w3-theme-d3 w3-border">
    <h4><?= __('Related Producto') ?>
        <button onClick="location.href='/producto/add/<?= $familia->id ?>/familia_id'" class="w3-button w3-xlarge w3-circle w3-black">+</button>
    </h4>
	...
	<div class="w3-responsive">
		<table class=" w3-table w3-border w3-bordered w3-hoverable w3-theme-d4">
        	<thead class="w3-border w3-black">  
                ...
                <th scope="col"><?= $this->Paginator->sort('moneda_id','moneda_id', ['model'=>'Producto']) ?></th>
